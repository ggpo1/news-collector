...
using NewsCollector.NewsToneAnalyzer;
...
builder.Services.Configure<NewsToneAnalyzerOptions>(builder.Configuration.GetSection(NewsToneAnalyzerOptions.SectionName));
builder.Services.AddPersistence(connectionString);
builder.Services.AddNewsToneAnalysis(builder.Configuration);
builder.Services.AddHostedService<NewsToneAnalyzerWorker>();
